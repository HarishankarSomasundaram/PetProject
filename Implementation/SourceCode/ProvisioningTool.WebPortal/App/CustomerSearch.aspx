<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerSearch.aspx.cs" Inherits="App_Masters_Search" %>
                ...
                <div class="container doubleColumn">
                    ...
                    <div class="hideContent toggle">
                        ...
                        <div id="widgetContentWrap">
                            <article class="widget singleColHeight" style="width: 100%; min-width: 1100px;margin-top: 25px;">
