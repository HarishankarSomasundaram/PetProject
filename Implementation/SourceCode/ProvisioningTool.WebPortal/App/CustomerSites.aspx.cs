...
public partial class MastersSiteInfo : FormController
{
    ...
    private void ModifySiteMaster()
    {
        try
        {
            ...
            if (response != null && response.Site != null)
            {
                ...
                ddlCustomer.Value = ConvertHelper.ConvertToString(response.Site.CustomerID);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            request.URL = url;
            request.Site.Customer.CustomerID = ConvertHelper.ConvertToInteger(ddlCustomer.Value);
            ...
            {
                request.Site.MappingID = ConvertHelper.ConvertToString(hidAutoTaskID.Value, "0");
