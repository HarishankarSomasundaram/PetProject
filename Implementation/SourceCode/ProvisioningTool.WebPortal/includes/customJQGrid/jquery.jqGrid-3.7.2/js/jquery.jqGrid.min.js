...
"0":k;h="parseFloat("+h+")";k="parseFloat("+k+")";break;case "date":case "datetime":k=String(a.jgrid.parseDate(g.newfmt||"m-d-Y",k).getTime());h='jQuery.jgrid.parseDate("'+g.srcfmt+'",'+h+").getTime()";break;default:h=f._getStr(h),k=f._getStr('"'+f._toStr(k)+'"')}f._append(h+" "+e+" "+k);f._setCommand(c,b);f._resetNegate();return f};this.equals=function(a,c,b){return f._compareValues(f.equals,a,c,"==",b)};this.notEquals=function(a,c,b){return f._compareValues(f.equals,a,c,"!==",b)};this.isNull=function(a,
...
b,d,e){return f._hasData()?f._getGroup(c,a,b,d,e):null};this.orderBy=function(c,b,d,e,g){b=null==b?"a":a.trim(b.toString().toLowerCase());null==d&&(d="text");null==e&&(e="m-d-Y");null==g&&(g=!1);if("desc"===b||"descending"===b)b="d";if("asc"===b||"ascending"===b)b="a";s.push({by:c,dir:b,type:d,datefmt:e,sfunc:g});return f};return f}(d,null)},getMethod:function(d){return this.getAccessor(a.fn.jqGrid,d)},extend:function(d){a.extend(a.fn.jqGrid,d);this.no_legacy_api||a.fn.extend(d)}});a.fn.jqGrid=function(d){if("string"===
